...
public class Ques3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Which header file supports malloc() and calloc() ?");

        jRadioButton1.setText("math.h");

        jRadioButton2.setText("stdlib.h");

        jRadioButton3.setText("conio.h");

        jRadioButton4.setText("time.h");
